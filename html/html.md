## Day 1: Foundations & Basic Markup
...
| **Module 5: Links & Responsive Images**    | • `<a href>` with `target`/`rel`<br>• Mailto/tel links<br>• `<img>` `src`, `alt`, <br>•       |
...
| Module                                      | Topics Covered                                                                                              | Activity / Exercise                                                 |
|---------------------------------------------|-------------------------------------------------------------------------------------------------------------|---------------------------------------------------------------------|
| **Module 11: Forms & Form Attributes**      | • `<form>` `action`, `method`<br>• `<fieldset>`, `<legend>`, `<label>`             | Build a contact form skeleton with labels and fieldsets            |
